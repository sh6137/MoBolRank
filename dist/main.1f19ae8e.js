...
},{"buffer":"node_modules/buffer/index.js"}],"node_modules/gsap/gsap-core.js":[function(require,module,exports) {
"use strict";
...
var list2El = document.querySelector('.mov_list_2');
var list3El = document.querySelector('.mov_list_3');
var list4El = document.querySelector('.mov_list_4');
var list5El = document.querySelector('.mov_list_5');
var list6El = document.querySelector('.mov_list_6');
var list7El = document.querySelector('.mov_list_7');
...
var list1El_detail = document.querySelector('.mov_list_1_detail');
...
list1El.addEventListener('click', function () {
  ...
  _gsap.default.to(list1El_detail, {
    delay: '1.1',
    display: 'block'
  });
});
